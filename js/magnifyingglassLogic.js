/* i-C-a */
$(function(){
  var zoom1 = new ZoomView('#mglass','#mglass :first');
});
    ...
    */
    ...
    function DragView(target) {
      ...
      this.OnDragStart = function(event) {
        ...
        $('div#mglass > img').css("-webkit-transform", "scale(2, 2)");
      }
      ...
      this.OnDragEnd = function(event) {
        ...
        if(position.left < 290 && position.left > 90 && position.top < 475 && position.top > 130) { //balhin na
          $("#magnifyhand").css({'visibility':'hidden', 'z-index':0});
          $("#livello").css({'visibility':'visible', 'z-index':2});
          $('div#mglass > img').css("visibility", "hidden");
          $('#instructions').html('Tap the "nucleus" or "electrons" to find out more.');
        } else { //i-uli sa
          $(target).animate({'top':'416px', 'left':'392px'}, 500);
        }
        $('div#mglass > img').css("-webkit-transform", "scale(1, 1)");
      }
    }
