...
btnClickSound.src = "audio/ButtonClick-Blip.mp3";

var cardSlideSound = new Audio();
cardSlideSound.src = "audio/CardSlide.mp3";

var menuOpenSound = new Audio();
menuOpenSound.src = "audio/MenuOpen.mp3";

var menuCloseSound = new Audio();
menuCloseSound.src = "audio/MenuClose.mp3";
